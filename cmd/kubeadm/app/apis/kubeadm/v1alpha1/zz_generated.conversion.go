...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_MasterNodeConfiguration_To_kubeadm_MasterNodeConfiguration,
		Convert_kubeadm_MasterNodeConfiguration_To_v1alpha1_MasterNodeConfiguration,
...
func autoConvert_v1alpha1_MasterNodeConfiguration_To_kubeadm_MasterNodeConfiguration(in *MasterNodeConfiguration, out *kubeadm.MasterNodeConfiguration, s conversion.Scope) error {
	out.NodeName = in.NodeName
	return nil
}

// Convert_v1alpha1_MasterNodeConfiguration_To_kubeadm_MasterNodeConfiguration is an autogenerated conversion function.
func Convert_v1alpha1_MasterNodeConfiguration_To_kubeadm_MasterNodeConfiguration(in *MasterNodeConfiguration, out *kubeadm.MasterNodeConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha1_MasterNodeConfiguration_To_kubeadm_MasterNodeConfiguration(in, out, s)
}

func autoConvert_kubeadm_MasterNodeConfiguration_To_v1alpha1_MasterNodeConfiguration(in *kubeadm.MasterNodeConfiguration, out *MasterNodeConfiguration, s conversion.Scope) error {
	out.NodeName = in.NodeName
	return nil
}

// Convert_kubeadm_MasterNodeConfiguration_To_v1alpha1_MasterNodeConfiguration is an autogenerated conversion function.
func Convert_kubeadm_MasterNodeConfiguration_To_v1alpha1_MasterNodeConfiguration(in *kubeadm.MasterNodeConfiguration, out *MasterNodeConfiguration, s conversion.Scope) error {
	return autoConvert_kubeadm_MasterNodeConfiguration_To_v1alpha1_MasterNodeConfiguration(in, out, s)
}
